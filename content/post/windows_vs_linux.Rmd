---
title: 'Why you should use Linux for data science, science and R'
...
I'll write a blog post in the future about the features of [Dolphin](https://www.kde.org).org/applications/system/dolphin/) the [KDE](https://www.kde.org) file manager on [Kubuntu](https://kubuntu.org).
...
macOS does not natively have one but the open-source [`homebrew`](https://brew.sh/index_de.html) project is really good.
...
1. It takes care of dependencies of libraries when a specific package is installed/removed.
2. It checks if updates for certain libraries are available, notifies the user and installs all of them.
